...
Original file is located at
    https://colab.research.google.com/drive/1ao9sEi-CYXydU6x81gBq0AFMR4SzyM8x
"""

from google.colab import drive
drive.mount('/content/drive')

zip_path = '/content/drive/My Drive/Sdl_Project/dataset.zip'
!cp "{zip_path}" .
!unzip -q dataset.zip
!rm dataset.zip
...
def load_all_imgs():
    ...
    for directory in directory_list:
        ...
        #aux_data=aux_data[:2500]
        #np.resize(aux_data,(785,1))
        data = np.concatenate((data, aux_data))

    df=pd.DataFrame(data,index=None)
    df.to_csv('/content/drive/My Drive/Sdl_Project/train_data.csv',index=False)
...
class ConvolutionalNeuralNetwork:
    def __init__(self):
        if os.path.exists('/content/drive/My Drive/Sdl_Project/model_weights.h5') and os.path.exists('/content/drive/My Drive/Sdl_Project/model.json'):
            self.load_model()
        else:
            self.create_model()
            self.train_model()
    ...
    def load_model(self):
        print('Loading Model...')
        model_json = open('/content/drive/My Drive/Sdl_Project/model.json', 'r')
        loaded_model_json = model_json.read()
        model_json.close()
        loaded_model = model_from_json(loaded_model_json)

        print('Loading weights...')
        loaded_model.load_weights("/content/drive/My Drive/Sdl_Project/model_weights.h5")

        self.model = loaded_model

    def train_model(self):
        if not os.path.exists('/content/drive/My Drive/Sdl_Project/train_data.csv'):
            load_all_imgs()

        csv_train_data = pd.read_csv('/content/drive/My Drive/Sdl_Project/train_data.csv', index_col=False)
    ...
    def export_model(self):
        ...
        with open('/content/drive/My Drive/Sdl_Project/model.json', 'w') as json_file:
            json_file.write(model_json)
        self.model.save_weights('/content/drive/My Drive/Sdl_Project/model_weights.h5')

    def predict(self):
        img = cv2.imread('/content/drive/My Drive/Sdl_Project/test12.jpg',cv2.IMREAD_GRAYSCALE)
